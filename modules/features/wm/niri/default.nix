{ inputs, self, ... }:
{
  flake.modules.homeManager.niri =
    ...
    let
      ...
      mon1 = self.myconf.monitor1;
      mon2 = self.myconf.monitor2;
      ...
      programs.niri = {
        ...
        settings = {
          ...
          binds = {
            ...
            "${m}+Shift+Ctrl+1".action.move-workspace-to-index = 1;
            "${m}+Shift+Ctrl+2".action.move-workspace-to-index = 2;
            "${m}+Shift+Ctrl+3".action.move-workspace-to-index = 3;
            "${m}+Shift+Ctrl+4".action.move-workspace-to-index = 4;
            "${m}+Shift+Ctrl+5".action.move-workspace-to-index = 5;
